...
<div style="display: flex; justify-content: center; gap: 60px; margin-bottom: 20px;">
  ...
  <!-- 动态爱心容器 <div id="heartContainer" style="width: 20%; display: flex; justify-content: flex-start; align-items: center; margin-left: 0px;">-->
  <div id="heartContainer" style="display: flex; justify-content: flex-start; align-items: center; margin-left: 0px;">
